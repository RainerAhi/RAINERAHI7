...
<div className="projects-section">
      ...
      <div className="project">
          ...
          <a href="https://room-example.vercel.app/" target="_blank" ><h1>PROJECT 1</h1></a>
      ...
      <div className="project">
        ...
        <div className="project">
          ...
          <a href="https://sodasite.vercel.app/" target="_blank" ><h1>PROJECT 3</h1></a>
          <img src="./arrow3.svg" alt="" className="svgarrow" />
        </div>
        <div className="border" />
        <div className="project">
        ...
        <div className="project">
          ...
          <a href="https://apple-vision-pro-immersive-website.vercel.app/" target="_blank" ><h1>PROJECT 6</h1></a>
          <img src="./arrow3.svg" alt="" className="arrow" />
        </div>
        <div className="border" />
        <div className="project">
          ...
          <a href="https://kalev-chocolate-showcase-by-rainer-ahi.vercel.app/" target="_blank" ><h1>PROJECT 7</h1></a>
          <img src="./arrow3.svg" alt="" className="arrow" />
        </div>
        <div className="border" />
        <div className="project">
